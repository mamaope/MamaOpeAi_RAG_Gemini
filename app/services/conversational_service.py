...
#          - **References:** [List the specific sources you referenced, including page numbers when available: {sources}]
...
# - Always remain evidence-based and cite relevant sources with page numbers when making clinical recommendations.
...
# - ALWAYS include the references section with page numbers when providing clinical assessments.
